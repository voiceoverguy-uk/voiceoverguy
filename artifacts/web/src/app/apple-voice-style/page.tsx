...
export default function Page() {
  return (
    <main className="inner-page">
      ...
      <InnerPage pageTitle={data.s1} pageSlug="apple-voice-style" formIntro="Need a polished Apple-style voice? Send me a quick message and I'll get back to you." sections={[
