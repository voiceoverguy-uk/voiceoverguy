...
export default function Page() {
  return (
    <main className="inner-page">
      ...
      <InnerPage pageTitle={data.s1} pageSlug="pathe-news-voice" formIntro="Looking for that classic Pathé-style delivery? Send me a quick message and I'll get back to you." afterMessageNode={<PreferredSourceButton />} sections={[
