...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.voiceoverguy.co.uk/assets/images/og-image-guy-harris.webp', width: 1200, height: 630, alt: 'David Attenborough Voice – Guy Harris' }],
  },
  twitter: {
...
export default function Page() {
  return (
    <main className="inner-page">
      ...
      <InnerPage pageTitle={data.s1} pageSlug="david-attenborough-voice" formIntro="Looking for a David Attenborough-style voice? Send me a quick message and I'll get back to you." afterMessageNode={<PreferredSourceButton />} sections={[
        ...(data.s4 ? [{ text: data.s4 }] : []),
        ...(data.s4 ? [{ audioSrc: '/assets/audio/david-attenborough-demo-25-guy-harris.mp3' }] : []),
