...
function Img({ src, alt }: { src: string; alt: string }) {
  return <img src={src} alt={alt} title={alt} style={{ width: '100%', marginTop: 8 }} />;
}
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.voiceoverguy.co.uk/assets/images/og-image-guy-harris.webp', width: 1200, height: 630, alt: 'Voiceover Studio – Guy Harris' }],
  },
  twitter: {
