...
export default function Page() {
  return (
    <main className="inner-page">
      ...
      <InnerPage pageTitle={data.s1} pageSlug="david-attenborough-voice" formIntro="Looking for a David Attenborough-style voice? Send me a quick message and I'll get back to you." beforeFormNode={<PreferredSourceButton />} sections={[
