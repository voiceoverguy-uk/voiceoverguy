...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.voiceoverguy.co.uk/assets/images/og-image-guy-harris.webp', width: 1200, height: 630, alt: 'Halloween Voice – Guy Harris' }],
  },
  twitter: {
...
export default function Page() {
  return (
    <main className="inner-page">
      ...
      <InnerPage pageTitle={data.s1} pageSlug="halloween-voice" formIntro="Looking for a spooky Halloween voice? Send me a quick message and I'll get back to you." afterMessageNode={<PreferredSourceButton />} sections={[
