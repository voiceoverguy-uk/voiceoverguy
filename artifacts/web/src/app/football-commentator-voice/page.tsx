...
export default function Page() {
  return (
    <main className="inner-page">
      ...
      <InnerPage pageTitle={data.s1} pageSlug="football-commentator-voice" formIntro="Need a football commentator voice for your project? Send me a quick message and I'll get back to you." afterMessageNode={<PreferredSourceButton />} sections={[
