...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.voiceoverguy.co.uk/assets/images/og-image-guy-harris.webp', width: 1200, height: 630, alt: 'Guy Harris – Commercial Voiceover Artist' }],
  },
  twitter: {
...
const schemas = [
  ...
  breadcrumb('commercial-voiceover', 'Commercial Voiceover'),
  ...
  videoObject('commercial-voiceover', data.s1, 'British commercial voiceover demo by Guy Harris, trusted by brands like Disney, Apple, Hotels.com and more.', 'ch6LhC-vqEA', '2016-06-21'),
  ...
  return (
    <main className="inner-page">
      ...
      <InnerPage pageTitle={data.s1} pageSlug="commercial-voiceover" formIntro="Want a punchy commercial voiceover? Send me a quick message and I'll get back to you." sections={[
        ...
        { audioSrc: '/assets/audio/commercial-voiceover-showreel-guy-harris.mp3', fullWidth: true },
        ...(data.s7 ? [{ youtubeId: data.s7 }] : []),
        ...(data.s5 ? [{ text: data.s5 }] : []),
        ...(data.s8 ? [{ youtubeId: data.s8 }] : []),
        ...(data.s6 ? [{ text: data.s6 }] : []),
        { imageSrc: '/assets/images/commercial-voiceover.webp', imageAlt: 'Commercial Voiceover \u2013 Guy Harris' },
      ]} />
