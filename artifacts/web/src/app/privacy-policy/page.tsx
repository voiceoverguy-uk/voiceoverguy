      ...
      <article className={styles.article}>
        <div className={styles.readingColumn}>
          ...
          <section id="retention" className={styles.section}>
            ...
            <p>I do not have a fixed deletion schedule for old emails, scripts or recordings. I review or clear them when storage fills up, rather than after a set period, so I cannot promise that messages are deleted after a particular number of months.</p>
