...
export function Scene5() {
  return (
    ...
    >
      <motion.div
        className="absolute bottom-[8vh] right-[10vw] w-[12vw] h-[0.3vh]"
      ...
      <motion.div
        className="absolute top-[30vh] right-[8vw] w-[5vw] h-[5vw] border border-white/5 rounded-sm"
        animate={{ rotate: [45, 135], opacity: [0.04, 0.07, 0.04] }}
