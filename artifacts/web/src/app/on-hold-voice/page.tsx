...
export default function Page() {
  return (
    <main className="inner-page">
      ...
      <InnerPage pageTitle={data.s1} pageSlug="on-hold-voice" formIntro="Looking for a professional on-hold voiceover? Send me a quick message and I'll get back to you." sections={[
