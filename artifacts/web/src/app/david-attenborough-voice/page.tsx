...
export default function Page() {
  return (
    <main className="inner-page">
      ...
      <InnerPage pageTitle={data.s1} pageSlug="david-attenborough-voice" formIntro="Looking for a David Attenborough-style voice? Send me a quick message and I'll get back to you." sections={[
        ...(data.s4 ? [{ text: data.s4, audioSrc: '/assets/audio/david-attenborough-demo-25-guy-harris.mp3' }] : []),
