...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.voiceoverguy.co.uk/assets/images/og-image-guy-harris.webp', width: 1200, height: 630, alt: 'On Hold Voice – Guy Harris' }],
  },
  twitter: {
...
const schemas = [
  ...
  videoObject('on-hold-voice', data.s1, 'On hold voice and IVR phone prompt demo by British voiceover artist Guy Harris.', 'cT7U03yDroE', '2014-07-29'),
...
export default function Page() {
  return (
    <main className="inner-page">
      ...
      <InnerPage pageTitle={data.s1} pageSlug="on-hold-voice" formIntro="Looking for a professional on-hold voiceover? Send me a quick message and I'll get back to you." afterMessageNode={<PreferredSourceButton />} sections={[
        ...(data.s4 ? [{ text: data.s4 }] : []),
        ...(data.s7 ? [{ youtubeId: data.s7 }] : []),
        ...(data.s5 ? [{ text: data.s5 }] : []),
        ...(data.s8 ? [{ youtubeId: data.s8 }] : []),
        ...(data.s6 ? [{ text: data.s6 }] : []),
        { imageSrc: '/assets/images/on-hold-voice-og.webp', imageAlt: 'On Hold Voice \u2013 Guy Harris' },
      ]} />
