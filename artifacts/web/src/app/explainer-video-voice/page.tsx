...
export default function Page() {
  return (
    <main className="inner-page">
      ...
      <InnerPage pageTitle={data.s1} pageSlug="explainer-video-voice" formIntro="Need a clear, friendly explainer voice? Send me a quick message and I'll get back to you." afterMessageNode={<PreferredSourceButton />} sections={[
